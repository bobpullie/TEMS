...
Usage:
  python -m tems.scaffold scaffold --agent-id myagent --agent-name "My Agent" --project MyProject --cwd "/path/to/agent"
  python -m tems.scaffold scaffold --agent-id myagent --agent-name "My Agent" --project MyProject --cwd "/path/to/agent" --force
"""
